[@directus/sdk-js](../README.md) > ["schemes/request/Collection"](../modules/_schemes_request_collection_.md) > [ICreateCollectionPresetBody](../interfaces/_schemes_request_collection_.icreatecollectionpresetbody.md)
